...
To address this finding, experiments with different dimension of SOM lattices were performed avoiding comparing users A and D at the same time. Fig. 4 shows results of user A and D respectively.

\begin{center}\includegraphics[scale=0.6]{fig-four} \end{center}
