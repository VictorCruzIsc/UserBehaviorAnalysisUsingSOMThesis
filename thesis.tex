...
In the case where the host has been compromised and it's being used to generate an attack, both previously explained behaviors can be detected over the network.
