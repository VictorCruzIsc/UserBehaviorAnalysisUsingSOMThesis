...
\subsection{Hypothesis} % level 2 REVISAR REDACCION Y SIGNIFICADO DEL PARRAFO 10
...
Debido a la alta tasa de falsos positivos que los algoritmos de machine learning arrojan, Muda [8] propone crear un m�todo hibrido de detecci�n de intrusos basado en K-Means y la t�cnica de clasificaci�n OneR, dicho algoritmo funciona a trav�s de la agrupaci�n de datos, basado en el comportamiento que presentan (comportamiento normal y comportamiento malicioso) a trav�s del algoritmo de clustering K-means, una vez agrupados, el algoritmo de clasificaci�n OneR permite identificar las diferentes clases de ataques que est�n presentes. El desempe�o del algoritmo es comparado con otros algoritmos: k-NN, Hierarchical Clustering + SVM y ESC-IDS, mostrando una reducci�n en la tasa de falsos positivos del 4.56% respecto a los dem�s algoritmos. 
