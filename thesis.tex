...
In Anomalies-based IDS, in order to avoid firms classification which implies spending time and human resources, firms are obtained from general datasets as KDCUPP99 [29-32], causing a big rate of false-positives, making the system not as reliable as it should be.
